      ...
      <div className="container">
        <div className="relative ">
          ...
          <Circle className="absolute left-0 -top-[400px]" animate>
            <motion.img src="/assets/images/cuboid.png" alt="Cuboid" className="size-[140px]" style={{
              rotate
            }}/>
          </Circle>
          </div>
          ...
          <Circle className="absolute -left-[600px] -top-[70px]" animate>
            <motion.img src="/assets/images/cylinder.png" alt="Cylinder" className="size-[140px]" style={{
              rotate
            }}/>
          </Circle>
          </div>
          <h2 className="font-heading font-black text-4xl md:text-5xl lg:6xl text-center">
